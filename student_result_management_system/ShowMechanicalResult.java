 ...
 * @author Sourav
 */
public class ShowMechanicalResult extends javax.swing.JFrame {

    /**
     * Creates new form ShowMechanicalResult
     */
    public ShowMechanicalResult() {
        initComponents();
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
       try{
           ...
           ResultSet rs = st.executeQuery("Select * from mechanicalresult");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowMechanicalResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
