 ...
 * @author Sourav
 */
public class ShowCSResult extends javax.swing.JFrame {

    /**
     * Creates new form ShowCSResult
     */
    public ShowCSResult() {
        initComponents();
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        try{
           ...
           ResultSet rs = st.executeQuery("Select * from csresult");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowCSResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
