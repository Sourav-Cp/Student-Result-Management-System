 ...
 * @author Sourav
 */
public class ShowCivilResult extends javax.swing.JFrame {

    /**
     * Creates new form ShowCivilResult
     */
    public ShowCivilResult() {
        initComponents();
    }
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
      try{
           ...
           ResultSet rs = st.executeQuery("Select * from civilresult");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowCivilResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
